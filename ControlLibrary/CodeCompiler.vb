...
Public Class CodeCompiler
    ...
    Public Sub New(ByVal CompilerHelper As CompilerHelper, ByVal Code As String)
    ...
    ''' Compila um código em tempo de execução.
    ''' </summary>
    ''' <param name="Path">O caminho do arquivo que contém o código a ser compilado.</param>
    ''' <param name="CompilerHelper">O objeto que fornece todas as informações necessárias para compilar o código.</param>
    Public Sub New(ByVal Path As String, ByVal CompilerHelper As CompilerHelper)
        _CompilerHelper = CompilerHelper
        _Path = Path
        _File = Nothing
        _Code = Nothing
